...
<head>
    ...
    <link rel="stylesheet" href="../Asset/css/Page8_Style.css">
...
<body>
    ...
    <main class="container" id="main">
        ...
        <div id="result" class="result-container">
            ...
            <div class="result-card" href="page9_File Mata Kuliah.php">
                <a href="page9_File Mata Kuliah.php"><img src="https://images.shiksha.com/mediadata/ugcDocuments/images/wordpressImages/2021_12_Difference-Between-Algorithm-and-Program_480x360.jpg" alt="diskrit.jpg"></a>
                <a href="page9_File Mata Kuliah.php"><h3>Algoritma dan Pemograman</h3></a>
                <a href="page9_File Mata Kuliah.php"><p>Pak Patrick</p></a>
            </div>
        </div>
    </main>
    ...
    <script src="../Asset/JS/page 8_Script.js"></script>
</body>
</html>