...
document.getElementById('add-file-form').addEventListener('submit', function(event) {
    ...
    const folderId = document.getElementById('folder-id').value;  // ID folder tempat file disimpan
    ...
    .then(data => {
        if (data.success) {
            ...
            location.reload();  // Reload halaman untuk menampilkan file yang baru diupload
        } else {
