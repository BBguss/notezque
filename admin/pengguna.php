                    ...
                    <div class="table-actions">
                        <form method="GET" class="filter-group">
                            ...
                            <select name="sort_by" class="filter-control" onchange="this.form.submit()">
                                ...
                                <option value="created_at_desc" <?= (isset($_GET['sort_by']) && $_GET['sort_by'] == 'created_at_desc') ? 'selected' : '' ?>>Tanggal Daftar Terbaru
                                </option>
                                <option value="created_at_asc" <?= (isset($_GET['sort_by']) && $_GET['sort_by'] == 'created_at_asc') ? 'selected' : '' ?>>Tanggal Daftar Terlama
                                </option>
                            </select>
                        </form>
                    ...
                    <tbody>
                        ...
                        while ($user = mysqli_fetch_assoc($result)):
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="hapus_user.php?id=<?= $user['id_user'] ?>" class="btn btn-outline btn-sm"
